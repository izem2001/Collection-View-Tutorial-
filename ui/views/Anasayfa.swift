...
class Anasayfa: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //10 x 10 x 10 -----> total boşluk 30
        let ekranGenislik = UIScreen.main.bounds.width
        let itemGenislik = (ekranGenislik - 30) / 2 //2'ye bölme sebebimiz 2 şer kutu şeklinde göstermemiz. Görünecek afiş sayısına bölebilirsin yani.
